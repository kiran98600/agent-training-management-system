(() => {
    ...
    module.exports = async (req, res, next) => {
        try {
            ...
            const validationResponse = await validationHelper.updateRequest(request);
            ...
            let updateObject = participantHelper.getUpdateObject(request)
            await participantRepository.update(updateObject);
